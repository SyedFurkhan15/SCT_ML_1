# SCT_ML_1
House Price Prediction using Linear Regression. Built a machine learning model to predict house prices based on living area, bedrooms, and bathrooms. Includes data visualization, model training, prediction, and performance evaluation using Python and Scikit-Learn.
# SCT_ML_1 - House Price Prediction

## Objective
Predict house prices using Linear Regression based on living area, bedrooms, and bathrooms.
